...
const PaginaRegistros = () => {
  ...
  // Dados dos registros - mesma estrutura que na navbar
      ...
      items: [
        {
          ...
          descricao: "Controle de administração de medicamentos para residentes"
        },
        {
        ...
        },
        {
          ...
          descricao: "Acompanhamento de sinais vitais e condições de saúde"
        },
        {
          path: "./RegistroExames",
          ...
          descricao: "Controle de solicitação e resultados de exames"
        }
      ]
    },
    {
      ...
      items: [
        {
          ...
          descricao: "Registro de preferências e interesses dos residentes"
        },
        {
          ...
          descricao: "Controle de atividades recreativas e terapêuticas"
        },
        {
          ...
          descricao: "Controle de dietas e alimentação dos residentes"
        },
      ]
    },
    {
      ...
      items: [
        {
          ...
          descricao: "Registro de incidentes e ocorrências no ambiente"
        },
        {
          ...
          descricao: "Acompanhamento comportamental dos residentes"
        },
      ]
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-odara-offwhite p-6">
            ...
            >
              <div className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="ml-4 text-xl font-semibold text-gray-800">{item.label}</h3>
                </div>
