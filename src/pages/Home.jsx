	...
	return (
		<main className="relative w-full min-h-screen overflow-x-hidden">
			...
			<section
				id="sobre"
				ref={sobreRef}
				className="min-h-screen bg-white flex items-center py-20 relative"
			>
				<div className="w-full px-6">
					<div className="max-w-6xl mx-auto text-center">
						<h2 className="text-4xl md:text-5xl font-bold text-odara-accent mb-6">
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 text-left">
							<div className="bg-odara-offwhite p-6 rounded-lg shadow-md border-l-4 border-odara-primary hover:scale-105 transition-transform duration-300">
								<h3 className="text-2xl font-bold text-odara-accent mb-4">
									Missão
								</h3>
								<p className="text-odara-dark leading-relaxed">
									O aplicativo para Instituições de Longa Permanência para Idosos tem como missão promover de forma inovadora e responsável a qualidade de vida, o bem-estar integral e a segurança dos residentes, utilizando a tecnologia como aliada no cuidado diário. A plataforma busca ser acessível, intuitiva e confiável, apoiando tanto a gestão administrativa da instituição quanto o monitoramento da saúde e a organização das rotinas.
								</p>
							</div>
							<div className="bg-odara-offwhite p-6 rounded-lg shadow-md border-l-4 border-odara-primary hover:scale-105 transition-transform duration-300">
								<h3 className="text-2xl font-bold text-odara-accent mb-4">
							...
							<div className="bg-odara-offwhite p-6 rounded-lg shadow-md border-l-4 border-odara-primary hover:scale-105 transition-transform duration-300">
								...
								<p className="text-odara-dark leading-relaxed">
									Os valores que sustentam o aplicativo são fundamentais para sua atuação: a humanização, colocando sempre o idoso no centro do cuidado, o respeito, reconhecendo direitos e necessidades individuais, a transparência, assegurando clareza nas informações, a inovação, utilizando a tecnologia como meio de transformação positiva, a acessibilidade, tornando a plataforma simples e inclusiva, a confiança, transmitindo credibilidade às famílias e instituições.
								</p>
							</div>
						</div>
						<div className="flex justify-center mt-12">
				...
				<div className="max-w-4xl mx-auto text-center">
					<div className="w-full px-6">
						...
						<div class="backdrop-blur-sm">
							<h2 className="text-4xl md:text-5xl font-bold text-odara-dark mb-8">
								Pronto para Começar?
							</h2>
							<p className="text-xl mb-12 text-odara-white max-w-2xl mx-auto">
								Junte-se a centenas de profissionais que já utilizam nosso
								sistema para otimizar seus cuidados.
							</p>
